...
<body>
    ...
    <section class="container py-5 ">
        ...
        <h1 class="h2  text-primary pt-3 text-center">Welcome To Royal Punch</h1>
...
<br>
        <div class="d-flex justify-content-center">
            ...
            <!-- Start Contact Form -->
            <div class="col-lg-9 ">
                <form class="contact-form col " method="post" action="login_class.php"  role="form">
                <span class="errorMsg" id="validation"></span>
                   <div class="row">
                    <div class="col-lg-6 mb-4 mx-auto">
                        <div class="form-floating">
                            <input type="email" class="form-control form-control-lg light-300" id="" name="email" placeholder="Name" required>
                            <label>Name</label>
                        </div>
                    </div>
                   </div>
                    ...
                    <div class="col-lg-6 mb-4 mx-auto">
                        <div class="form-floating">
                            <input type="password" class="form-control form-control-lg light-300" id="" name="password" placeholder="Password" required>
                    ...
                    <div class="col-md-12 col-12 m-auto text-center">
                        <button type="submit" name="login" class="btn btn-secondary rounded-pill px-md-5 px-4 py-2 radius-0 text-light light-300">login</button>
                    </div>
