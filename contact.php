...
<head>
    <title>Royal Punch - Contact</title>
    <meta charset="utf-8">
...
<body>
    ...
    <section class="container py-5">
        ...
        <div class="row pb-4">
            ...
            <!-- Start Contact Form -->
            <div class="col-lg-8 ">
                <form class="contact-form row" method="POST" action="contact_class.php" role="form">

                    <div class="col-lg-6 mb-4">
                        <div class="form-floating">
                            <input type="text" class="form-control form-control-lg light-300" id="floatingname" name="c_name" placeholder="Name" Required>
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="form-floating">
                            <input type="email" class="form-control form-control-lg light-300" id="floatingemail" name="c_email" placeholder="Email" Required>
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="form-floating">
                            <input type="text" class="form-control form-control-lg light-300" id="floatingphone" name="c_phone" placeholder="Phone" Required>
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="form-floating">
                            <input type="text" class="form-control form-control-lg light-300" id="floatingcompany" name="c_companyname" placeholder="Company Name" Required>
                    ...
                    <div class="col-12">
                        <div class="form-floating mb-4">
                            <input type="text" class="form-control form-control-lg light-300" id="floatingsubject" name="c_subject" placeholder="Subject" Required>
                    ...
                    <div class="col-12">
                        <div class="form-floating mb-3">
                            <textarea class="form-control light-300" rows="8" placeholder="Message" name="c_message" id="floatingtextarea" Required></textarea>
                            <label for="floatingtextarea light-300">Message</label>
                        </div>
                    </div><!-- End Textarea Message -->

                    <div class="col-md-12 col-12 m-auto text-end">
                        <button type="submit" name="contact_us" class="btn btn-secondary rounded-pill px-md-5 px-4 py-2 radius-0 text-light light-300">Send Message</button>
                    </div>
